...
#словарь гласных русского языка с ё

my_dict = {"АЕЁИОУЭЮЫЯ": 1}

word = input('Введите стих: ')

summa = sum([i[1] for i in my_dict.items() for j in word if j.upper() in i[0]])
print(summa)

if summa % 2 == 0:
    print('Парам пам-пам, ритм супер')
else:
    print('Пам парам, c ритмом не очень')
